...
- [Calin.ScrewFastening.StateMachine 狀態機模組](#calinscrewfasteningstatemachine-狀態機模組)
  - [目錄](#目錄)
  - [概述](#概述)
  - [核心組件](#核心組件)
    - [1. MachineState 枚舉](#1-machinestate-枚舉)
    - [2. MachineTrigger 枚舉](#2-machinetrigger-枚舉)
    - [3. SubsystemState 枚舉](#3-subsystemstate-枚舉)
    - [4. 預設子系統](#4-預設子系統)
  - [狀態機流程圖](#狀態機流程圖)
    - [機台狀態轉換圖](#機台狀態轉換圖)
    - [典型操作流程](#典型操作流程)
  ...
  - [狀態轉換規則](#狀態轉換規則)
    ...
    - [特殊規則](#特殊規則)
  - [UI 控制元件](#ui-控制元件)
    - [1. MachineControlPanel](#1-machinecontrolpanel)
    - [2. MachineStateIndicator](#2-machinestateindicator)
    - [3. SubsystemStatusPanel](#3-subsystemstatuspanel)
  - [最佳實踐](#最佳實踐)
    - [1. 初始化順序](#1-初始化順序)
    - [2. 錯誤處理](#2-錯誤處理)
    - [3. 取消操作](#3-取消操作)
